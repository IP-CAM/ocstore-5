      ...
      <table class="table table-bordered table-hover table-product">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><a href="<?php echo $download['href']; ?>" data-toggle="tooltip" title="<?php echo $button_download; ?>" class="btn btn-primary button-orange"><i class="fa fa-cloud-download"></i></a></td>
          </tr>
          <?php } ?>
        </tbody>
      </table>
