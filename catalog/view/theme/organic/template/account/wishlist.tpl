          ...
          <tbody>
            ...
            <tr>
              <td class="text-center img-thumb-wrap"><?php if ($product['thumb']) { ?>
                ...
                <?php } ?></td>
              <td class="text-left title-cart"><a href="<?php echo $product['href']; ?>"><?php echo $product['name']; ?></a></td>
              <td class="text-right total-price"><?php if ($product['price']) { ?>
                <div class="price">
                ...
                <?php } ?>
                <a href="<?php echo $product['remove']; ?>" data-toggle="tooltip" title="<?php echo $button_remove; ?>" class="btn btn-danger button-remove"><i class="fa fa-times"></i></a></td>
            </tr>
            <?php } ?>
          </tbody>
        </table>
