<div class="row login-block">
  <div class="col-sm-6">
    <fieldset id="account">
      ...
      <div class="form-group required">
        <input type="text" name="firstname" value="<?php echo $firstname; ?>" placeholder="<?php echo $entry_firstname; ?>*" id="input-payment-firstname" class="form-control input-main-site" />
      </div>
      <div class="form-group required">
        <input type="text" name="lastname" value="<?php echo $lastname; ?>" placeholder="<?php echo $entry_lastname; ?>*" id="input-payment-lastname" class="form-control input-main-site" />
      </div>
      <div class="form-group required">
        <input type="text" name="email" value="<?php echo $email; ?>" placeholder="<?php echo $entry_email; ?>*" id="input-payment-email" class="form-control input-main-site" />
      </div>
      <div class="form-group required">
        <input type="text" name="telephone" value="<?php echo $telephone; ?>" placeholder="<?php echo $entry_telephone; ?>*" id="input-payment-telephone" class="form-control input-main-site" />
      </div>
      <div class="form-group">
        <input type="text" name="fax" value="<?php echo $fax; ?>" placeholder="<?php echo $entry_fax; ?>" id="input-payment-fax" class="form-control input-main-site" />
      </div>
  ...
  <div class="col-sm-6">
    <fieldset id="address">
      <div class="form-group">
        <input type="text" name="company" value="<?php echo $company; ?>" placeholder="<?php echo $entry_company; ?>" id="input-payment-company" class="form-control input-main-site" />
      </div>
      <div class="form-group required">
        <input type="text" name="address_1" value="<?php echo $address_1; ?>" placeholder="<?php echo $entry_address_1; ?>*" id="input-payment-address-1" class="form-control input-main-site" />
      </div>
      <div class="form-group">
        <input type="text" name="address_2" value="<?php echo $address_2; ?>" placeholder="<?php echo $entry_address_2; ?>" id="input-payment-address-2" class="form-control input-main-site" />
      </div>
      <div class="form-group required">
        <input type="text" name="city" value="<?php echo $city; ?>" placeholder="<?php echo $entry_city; ?>*" id="input-payment-city" class="form-control input-main-site" />
      </div>
      <div class="form-group required">
        <input type="text" name="postcode" value="<?php echo $postcode; ?>" placeholder="<?php echo $entry_postcode; ?>*" id="input-payment-postcode" class="form-control input-main-site" />
      </div>
      <div class="form-group required">
...
<div class="buttons clearfix">
  <div class="pull-right">
    <input type="button" value="<?php echo $button_continue; ?>" id="button-guest" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary button-orange" />
  </div>
</div>
