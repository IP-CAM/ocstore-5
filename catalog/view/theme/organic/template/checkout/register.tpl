  ...
  <div class="col-sm-6">
    <fieldset id="account">
      ...
      <div class="form-group required">
        <input type="text" name="firstname" value="" placeholder="<?php echo $entry_firstname; ?>*" id="input-payment-firstname" class="form-control input-main-site" />
      </div>
      <div class="form-group required">
        <input type="text" name="lastname" value="" placeholder="<?php echo $entry_lastname; ?>*" id="input-payment-lastname" class="form-control input-main-site" />
      </div>
      <div class="form-group required">
        <input type="text" name="email" value="" placeholder="<?php echo $entry_email; ?>*" id="input-payment-email" class="form-control input-main-site" />
      </div>
      <div class="form-group required">
        <input type="text" name="telephone" value="" placeholder="<?php echo $entry_telephone; ?>*" id="input-payment-telephone" class="form-control input-main-site" />
      </div>
      <div class="form-group">
        <input type="text" name="fax" value="" placeholder="<?php echo $entry_fax; ?>" id="input-payment-fax" class="form-control input-main-site" />
      </div>
      ...
      <div id="payment-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-group custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
        ...
        <select name="custom_field[<?php echo $custom_field['location']; ?>][<?php echo $custom_field['custom_field_id']; ?>]" id="input-payment-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-control input-main-site">
    ...
    <fieldset>
      <div class="form-group required">
        <input type="password" name="password" value="" placeholder="<?php echo $entry_password; ?>*" id="input-payment-password" class="form-control input-main-site" />
      </div>
      <div class="form-group required">
        <input type="password" name="confirm" value="" placeholder="<?php echo $entry_confirm; ?>*" id="input-payment-confirm" class="form-control input-main-site" />
      </div>
    </fieldset>
  </div>
  <div class="col-sm-6">
    <fieldset id="address">
      <div class="form-group">
        <input type="text" name="company" value="" placeholder="<?php echo $entry_company; ?>" id="input-payment-company" class="form-control input-main-site" />
      </div>
      <div class="form-group required">
        <input type="text" name="address_1" value="" placeholder="<?php echo $entry_address_1; ?>*" id="input-payment-address-1" class="form-control input-main-site" />
      </div>
      <div class="form-group">
        <input type="text" name="address_2" value="" placeholder="<?php echo $entry_address_2; ?>" id="input-payment-address-2" class="form-control input-main-site" />
      </div>
      <div class="form-group required">
        <input type="text" name="city" value="" placeholder="<?php echo $entry_city; ?>*" id="input-payment-city" class="form-control input-main-site" />
      </div>
      <div class="form-group required">
        <input type="text" name="postcode" value="<?php echo $postcode; ?>" placeholder="<?php echo $entry_postcode; ?>*" id="input-payment-postcode input-main-site" class="form-control input-main-site" />
      </div>
      <div class="form-group required">
        <select name="country_id" id="input-payment-country" class="form-control input-main-site">
          <option value=""><?php echo $text_select; ?></option>
      ...
      <div class="form-group required">
        <select name="zone_id" id="input-payment-zone" class="form-control input-main-site">
        </select>
      </div>
      <?php foreach ($custom_fields as $custom_field) { ?>
...
<div class="buttons clearfix">
  <div class="pull-right"><?php echo $text_agree; ?> &nbsp;
    ...
    <input type="button" value="<?php echo $button_continue; ?>" id="button-register" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary button-orange" />
  </div>
</div>
<?php } else { ?>
<div class="buttons clearfix">
