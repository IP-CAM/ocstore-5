<form class="form-horizontal login-block">
  <div class="form-group required clearfix">
    <div class="col-sm-6">
      <input type="text" name="firstname" value="<?php echo $firstname; ?>" placeholder="<?php echo $entry_firstname; ?>*" id="input-shipping-firstname " class="form-control input-main-site" />
    </div>
  </div>
  <div class="form-group required">
    <div class="col-sm-6">
      <input type="text" name="lastname" value="<?php echo $lastname; ?>" placeholder="<?php echo $entry_lastname; ?>*" id="input-shipping-lastname" class="form-control input-main-site" />
    </div>
  </div>
  <div class="form-group">
    <div class="col-sm-6">
      <input type="text" name="company" value="<?php echo $company; ?>" placeholder="<?php echo $entry_company; ?>" id="input-shipping-company" class="form-control input-main-site" />
    </div>
  </div>
  <div class="form-group required">
    <div class="col-sm-6">
      <input type="text" name="address_1" value="<?php echo $address_1; ?>" placeholder="<?php echo $entry_address_1; ?>*" id="input-shipping-address-1" class="form-control input-main-site" />
    </div>
  </div>
  <div class="form-group">
    <div class="col-sm-6">
      <input type="text" name="address_2" value="<?php echo $address_2; ?>" placeholder="<?php echo $entry_address_2; ?>" id="input-shipping-address-2" class="form-control input-main-site" />
    </div>
  </div>
  <div class="form-group required">
    <div class="col-sm-6">
      <input type="text" name="city" value="<?php echo $city; ?>" placeholder="<?php echo $entry_city; ?>*" id="input-shipping-city" class="form-control input-main-site" />
    </div>
  </div>
  <div class="form-group required">
    <div class="col-sm-6">
      <input type="text" name="postcode" value="<?php echo $postcode; ?>" placeholder="<?php echo $entry_postcode; ?>*" id="input-shipping-postcode" class="form-control input-main-site" />
    </div>
  </div>
  <div class="form-group required">
    <div class="col-sm-6">
      <select name="country_id" id="input-shipping-country" class="form-control input-main-site">
  ...
  <div class="form-group required">
    <div class="col-sm-6">
      <select name="zone_id" id="input-shipping-zone" class="form-control input-main-site">
      </select>
    </div>
  </div>
  ...
  <div class="form-group<?php echo ($custom_field['required'] ? ' required' : ''); ?> custom-field" data-sort="<?php echo $custom_field['sort_order']; ?>">
    <div class="col-sm-6">
      <select name="custom_field[<?php echo $custom_field['custom_field_id']; ?>]" id="input-shipping-custom-field<?php echo $custom_field['custom_field_id']; ?>" class="form-control input-main-site">
        <option value=""><?php echo $text_select; ?></option>
  ...
  <div class="buttons clearfix">
    <div class="pull-right">
      <input type="button" value="<?php echo $button_continue; ?>" id="button-guest-shipping" data-loading-text="<?php echo $text_loading; ?>" class="btn btn-primary button-orange" />
    </div>
  </div>
</form>
