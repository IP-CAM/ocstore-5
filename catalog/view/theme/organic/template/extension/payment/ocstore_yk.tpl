...
<div class="buttons">
  <div class="pull-right">
    ...
    <input type="button" value="<?php echo $button_laterpay; ?>" id="button-laterpay" class="btn btn-primary button-orange" />
    <?php } ?>
    <input type="button" value="<?php echo $button_confirm; ?>" id="button-confirm" class="btn btn-primary button-orange" />
  </div>
