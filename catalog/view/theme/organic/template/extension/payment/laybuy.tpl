...
<div class="buttons">
  <div class="pull-right">
    <input type="submit" form="laybuy-form" value="<?php echo $button_confirm; ?>" id="button-confirm" class="btn btn-primary button-orange" data-loading-text="<?php echo $text_loading; ?>">
  </div>
</div>
