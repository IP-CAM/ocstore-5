...
<div class="container"><?php echo $content_top; ?>
	...
	<div class="buttons">
		<div class="pull-left">
			<a href="<?php echo $cart; ?>" class="btn btn-primary button-orange"><?php echo $text_cart; ?></a>
		</div>
		<div class="pull-right">
			<input class="btn btn-primary button-orange" id="continue-button" type="submit" value="<?php echo $text_continue; ?>" />
		</div>
	</div>
